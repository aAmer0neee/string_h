...
This project uses a `Makefile` to manage the compilation and testing process. To work with this project, you will need the following tools:

- Compiler `gcc`

  `sudo apt install gcc`

- Utility `lcov` for code coverage

  `sudo apt install lcov`

- Libraries `check`, `subunit` for testing
